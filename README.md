...
### 1.Configurations
In this stage, the coded aperture pattern is a real mask with the size of 256 * 256, provided by [Meng et al.](https://github.com/mengziyi64/TSA-Net). The file can be downloaded in [mask.mat](https://github.com/MaxtBIT/Summary-of-Codes-for-HSI-Reconstruction/blob/master/data/mask.mat). The other details of the simulation are the same as ICVL Dataset.
