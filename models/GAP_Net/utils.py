...
import torch 
import logging
from models.GAP_Net.ssim_torch import ssim
...
def generate_masks(mask_path, batch_size):
    ...
    Phi_batch = mask_3d_shift.unsqueeze(0).cuda().float() # only to calculate the parameters and FLOPs, modified by MaxtBIT
